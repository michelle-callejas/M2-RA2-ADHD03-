  ...
  <div class="container">
    ...
    <div class="jumbotron jumbotron-fluid animate__animated animate__wobble">
      <div class="container">
        ...
        <h1>Nuevo Municipio</h1><br>
        <form action="agregar_municipio" method="post">
          <div class="mb-8">
            <label for="txtId" class="form-label">Código de municipio</label>
          ...
          <div class="mb-8">
            ...
            <input type="number" id="txtCodDepto" class="form-control" name="txtCodDepto"
              placeholder="Ingrese su código de departamento">
          </div>
          <br><br>
