...
<nav class="navbar navbar-expand-lg bg-body-tertiary border  border-dark">
    ...
    <br><br>
    <a href="nuevo_nivel" class="btn btn-dark">Nuevo Nivel Académico</a>  
    <br><br>
    <table class="table table-border table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                            <a href="<?= base_url('buscar_nivel/').$nivel['cod_nivel_acad']?>" class="btn btn-success "> <i class="bi bi-pencil-square">Actualizar</i></a>
                            <a href="<?= base_url('eliminar_nivel/').$nivel['cod_nivel_acad']?>" class="btn btn-danger "> <i class="bi bi-trash">Eliminar</i></a>
                        </td>
